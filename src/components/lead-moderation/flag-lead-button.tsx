	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			>
				...
				<DialogDescription>
					Are you sure you want to flag this lead? Flagged leads are excluded
					from exports and marked for moderation.
				</DialogDescription>
				<div className="mt-2 flex space-x-3 border-gray-200 border-t pt-6">
					...
					<Button
						className="flex-1 border border-orange-400 bg-white text-orange-600 transition-colors duration-150 hover:border-orange-500 hover:text-orange-700"
						variant="outline"
						type="button"
						disabled={isPending}
						onClick={handleFlag}
