import type { PaginatedScraperLogResponse } from "@/types/scraper_log";
			...
			<div className="flex min-h-[400px] items-center justify-center rounded-lg border border-red-200 bg-red-50">
				<div className="text-center">
					<h3 className="font-medium text-lg text-red-900">
						Unable to load scraper logs
					</h3>
					<p className="mt-1 text-red-600 text-sm">
						There was a problem loading your scraper log data. Please refresh
