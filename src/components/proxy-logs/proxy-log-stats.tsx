...
import type { ProxyLogStats } from "@/types/proxy_log";
import {
	AlertCircle,
	BarChart3,
	CheckCircle2,
			...
			<Card className="border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="font-bold text-gray-900 text-xl">{stats?.banned}</p>
					</div>
			...
			<Card className="border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md">
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="font-bold text-gray-900 text-xl">{stats?.timeout}</p>
					</div>
