...
interface InvoiceListProps {
  response: PaginatedInvoiceResponse;
  isLoading: boolean;
  isFetching: boolean;
  error: Error | null;
  pagination: {
    ...
    return (
      <div className="flex min-h-[400px] items-center justify-center rounded-lg border border-red-200 bg-red-50">
        <div className="text-center">
          <h3 className="font-medium text-lg text-red-900">Unable to load invoices</h3>
          <p className="mt-1 text-red-600 text-sm">There was a problem loading your invoice data. Please refresh the page or try again.</p>
        </div>
      </div>
    );
  }
        ...
        {!isLoading && invoices.length === 0 && (
          <div className="mt-2 flex min-h-[300px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50">
            <div className="text-center">
              ...
              <h3 className="mt-4 font-medium text-gray-900 text-lg">No invoices found</h3>
