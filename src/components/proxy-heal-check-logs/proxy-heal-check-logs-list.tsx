...
import { PaginatedProxyHealCheckLogResponse } from "@/types/proxy_heal_check_log";
    ...
    return (
      <div className="flex min-h-[400px] items-center justify-center rounded-lg border border-red-200 bg-red-50">
        <div className="text-center">
          <h3 className="font-medium text-lg text-red-900">Unable to load proxy heal check logs</h3>
          <p className="mt-1 text-red-600 text-sm">There was a problem loading your proxy heal check log data. Please refresh the page or try again.</p>
        </div>
      </div>
    );
  }
        ...
        {!isLoading && logs.length === 0 && (
          <div className="mt-2 flex min-h-[300px] items-center justify-center rounded-lg border border-gray-200 bg-gray-50">
            <div className="text-center">
              ...
              <h3 className="mt-4 font-medium text-gray-900 text-lg">No proxy heal check logs found</h3>
