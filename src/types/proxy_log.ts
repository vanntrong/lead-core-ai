...
export type ProxyLogInsert = Database["public"]["Tables"]["proxy_logs"]["Insert"];
export type ProxyLogUpdate = Database["public"]["Tables"]["proxy_logs"]["Update"];
...
export interface UpdateProxyLogData extends Partial<ProxyLogRow> { id: string; }
