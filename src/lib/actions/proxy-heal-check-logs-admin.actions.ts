...
export async function getProxyHealCheckLogsAdminAction(
...
export async function getProxyHealCheckLogsPaginatedAdminAction(
	filters?: ProxyHealCheckLogFilters
) {
	try {
...
export async function createProxyHealCheckLogAdminAction(
	data: CreateProxyHealCheckLogData
) {
	try {
...
export async function updateProxyHealCheckLogAdminAction(
	data: UpdateProxyHealCheckLogData
) {
	try {
