...
import type { CreateScraperLogData, ScraperLogFilters, UpdateScraperLogData } from "@/types/scraper_log";
...
export async function getScraperLogsPaginatedAdminAction(filters?: ScraperLogFilters) {
  try {
