      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-gray-600 text-lg">
            Please review the terms, disclaimers, and contact information for LeadCore AI below.
          </p>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="mb-8 rounded-lg bg-gray-50 p-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              While every effort has been made to ensure accuracy, we cannot guarantee
              that all data, enrichment, scoring, or campaign recommendations will
              be error-free or yield specific results. Use of this software is at
              your own risk.
            </p>
            <hr className="my-4 border-gray-200" />
            <p className="text-gray-700 leading-relaxed">
              Bug Hutch Ltd and its directors accept no liability
              for any loss, damages, or business impact arising from use of this
              platform.
            </p>
            <hr className="my-4 border-gray-200" />
            <p className="text-gray-700 leading-relaxed">
              Users remain fully responsible for verifying leads,
              campaigns, compliance, and for meeting all applicable advertising
              and data protection regulations (including GDPR, CAN-SPAM, and local
              laws).
            </p>
            <hr className="my-4 border-gray-200" />
            <p className="text-gray-700 leading-relaxed">
              By using this site and product, you accept these terms in
              full.
            </p>
          </div>
        </div>
