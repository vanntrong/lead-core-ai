			...
			<div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
				<div className="mb-12 text-center">
					...
					<p className="mt-4 text-gray-600 text-lg">
						Learn more about LeadCore AI, our mission, and the team behind the
						platform.
					</p>
				...
				<div className="prose prose-lg max-w-none">
					<div className="mb-8 rounded-lg bg-gray-50 p-6">
						<p className="mb-4 text-gray-700 leading-relaxed">
							LeadCore AI is a next-generation SaaS platform built by Bug Hutch
							Ltd, led by founder Lee Caston.
						</p>
						<hr className="my-4 border-gray-200" />
						<p className="mb-4 text-gray-700 leading-relaxed">
							Our mission is simple: to give businesses and agencies the tools
							to find, enrich, and connect with the right leads—faster, smarter,
							and more compliantly than ever before.
						</p>
						<hr className="my-4 border-gray-200" />
						<p className="mb-4 text-gray-700 leading-relaxed">
							LeadCore integrates advanced AI enrichment, verified email
							intelligence, and outbound bridges to help operators scale.
						</p>
						<hr className="my-4 border-gray-200" />
						<p className="text-gray-700 leading-relaxed">
							Bug Hutch Ltd is a UK-based technology company focused on building
							sovereign SaaS tools that empower entrepreneurs, agencies, and
							operators worldwide.
						</p>
					</div>
				</div>
