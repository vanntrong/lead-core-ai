...
import {
	useScraperLogsPaginatedAdmin,
	useScraperLogStatsAdmin,
} from "@/hooks/use-scraper-logs-admin";
import { cn } from "@/lib/utils";
import type { ScraperLogFilters } from "@/types/scraper_log";
			...
			<div className="mx-auto space-y-8 px-4 py-8 sm:px-6 lg:px-8">
				<div className="mb-8">
					...
					<p className="text-gray-600 text-lg">
						Monitor and audit all scraper operations.
					</p>
				</div>
