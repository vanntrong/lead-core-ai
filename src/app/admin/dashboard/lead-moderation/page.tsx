  ...
  return (
    <DashboardLayout>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="font-bold text-gray-900 text-xl">Lead Moderation</h1>
      ...
      <div className="mx-auto space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="mb-2 font-bold text-3xl text-gray-900">Moderate Leads</h2>
          <p className="text-gray-600 text-lg">Review, update, or delete leads as an admin.</p>
        </div>
