      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="mt-4 text-gray-600 text-lg">
            By accessing and using LeadCore AI, you agree to the following terms:
          </p>
          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                LeadCore AI provides scraping, enrichment, and campaign tools on a
                subscription basis. You agree to use the service only for lawful
                purposes and in compliance with all relevant regulations,
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                of this service. Users are solely responsible for compliance with
                GDPR, CAN-SPAM, and all applicable regulations.
              </p>
            </section>
            <section>
              <h2 className="mb-4 font-semibold text-2xl text-gray-900">
              ...
              <p className="text-gray-700 leading-relaxed">
                Bug Hutch Ltd reserves the right to suspend or terminate accounts
                that breach these terms or abuse the platform.
              </p>
            </section>
            <section>
              <h2 className="mb-4 font-semibold text-2xl text-gray-900">
        ...
        <div className="mt-12 flex justify-center">
          <div className="rounded-lg p-6 w-full max-w-md">
            <h2 className="mb-3 text-xl font-semibold text-gray-900 text-center">
              Contact
            </h2>
